...
class Thermometer: CustomStringConvertible {
    ...
    var description: String {
        return "The current temperature is \(self.fahrenheit)°F (\(self.celsius)°C)"
    }
 ...
 */
// write your code here
let thermometer = Thermometer.init(fahrenheit: 88.0)
...
print(thermometer)  // The current temperature is 212.0°F (100.0°C)